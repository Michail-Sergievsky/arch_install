...
# yay soft
yay -S polybar dumptorrent hibernator ly nerd-fonts-source-code-pro rofi-blezz rofi-dmenu rofi-greenclip siji-git simple-mtpfs ttf-ms-fonts ttf-weather-icons update-grub urxvt-resize-font-git freac dropbox hunspell-ru hyphen-ru libreoffice-extension-languagetool transgui-gtk zoom anki goldendict-ng mcomix downgrade pacman-cleanup-hook icons-in-terminal-git epub-thumbnailer-git fontpreview i3-gnome-pomodoro-git google-chrome networkmanager-fortisslvpn

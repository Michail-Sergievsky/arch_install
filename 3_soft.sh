...
# soft work
sudo pacman -S vagrant virtualbox virtualbox-guest-iso virtualbox-host-modules-arch docker docker-compose ansible wireshark-cli wireshark-qt freerdp virt-manager python-psycopg2

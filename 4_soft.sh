...
# soft work
sudo pacman -S --needed --noconfirm vagrant virtualbox virtualbox-guest-iso virtualbox-host-modules-arch docker ansible wireshark-cli wireshark-qt
yay -S --needed --noconfirm visual-studio-code-bin

# more work stuff
sudo pacman -S --needed --noconfirm remmina
yay -S --needed --noconfirm rocketchat-client-bin 
